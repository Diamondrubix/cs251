...
class List
{
  ...
  public:
    ...
    void qsort(){
      ...
      // a little clunky... 
      //   sorted list is currently in left
      //   we want it to be in the calling object
      //   first set fields of *this to equal those of *left
      *this = *left;
...
public:
    ...
    List<T> * prefix(unsigned int k) {
      List<int> *lhs; // stores the prefix to return
      Node *p;
      int i;
